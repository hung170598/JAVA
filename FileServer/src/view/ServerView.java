...
public class ServerView extends javax.swing.JFrame {
    ...
    public ServerView() {
        initComponents();
        this.logList = new javax.swing.JList<>(model);
    }
    ...
    private void initComponents() {
        ...
        logList.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
    ...
    public void showLog(String log){
        model.addElement(LocalTime.now() + ": " + log);
        logList.setVisible(rootPaneCheckingEnabled);
    }
}
